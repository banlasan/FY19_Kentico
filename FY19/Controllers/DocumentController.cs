...
namespace FY19.Controllers
{
    ...
    public class DocumentController : PageTemplateController
    {
        // GET: Document
        public ActionResult Index()
        {
            TreeNode page = DocumentHelper.GetDocuments().Path("/business/solution/Document").OnCurrentSite().TopN(1).FirstOrDefault();
            if (page == null)
            {
                return HttpNotFound();
            }
